...
using CSharpMarkupPeopleInSpaceMaui.Extensions;
using CSharpMarkupPeopleInSpaceMaui.Models;
...
namespace CSharpMarkupPeopleInSpaceMaui.ViewModels;
...
public class MainPageViewModel : ReactiveObject, IActivatableViewModel
{
    ...
    [Reactive]
    public string PageTitle { get; private set; } = "People In Space CSharp Markup MAUI";
